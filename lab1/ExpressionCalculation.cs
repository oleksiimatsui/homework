...
namespace ExpressionCalculation
{
    public partial class ExpCalcForm : Form
    {
        ...
        private void dovidka_btn_Click(object sender, EventArgs e)
        {
            hide_file();
            hide_edit();
            hide_about();
            if (dovidka_panel.Visible == false)
            {
                dovidka_panel.Visible = true;
                dovidka_btn.BackColor = SystemColors.Control;
            }
            else
            {
                dovidka_panel.Visible = false;
                dovidka_btn.BackColor = SystemColors.ActiveCaption;
            }
        }
